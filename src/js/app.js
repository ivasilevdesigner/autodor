    ...
    $('#greetModal').on('show.bs.modal', function (event) {
        ...
        switch (text) {
            ...
            case 9: 
                ...
                break; 
            case 10: 
                $('.greet-text').append('  <h2>Уважаемые коллеги!</h2><p>От имени акционеров, руководства и большого коллектива компании «Dонаэродорстрой» хочу поприветствовать участников, гостей и организаторов Конференции «Скорость, безопасность, комфорт. Опыт десятилетия»!</p><p>Обеспечить страну скоростными, безопасными и комфортными автодорогами способны только настоящие профессионалы, только те, кто с каждым годом своей деятельности подтверждают свои лидирующие позиции в отрасли. </p><p>«Dонаэродорстрой» уже более шести десятилетий продолжает удерживать курс на качественное выполнение всех взятых на себя обязательств, ответственное исполнение всех заключенных договоров и контрактов. </p><p>Совместно c Государственной компанией «Автодор» было сделано многое. Успешно введены в строй новые километры дорог, применены инновационные решения при строительстве, реконструкции и ремонте объектов транспортной инфраструктуры федерального значения. </p><p>Безусловно, очередная встреча на Конференции поспособствует дальнейшему непрерывному развитию всей дорожной отрасли, даст возможность профильным компаниям поделиться своими накопленными знаниями и опытом со всеми участниками мероприятия. </p><p>Позвольте пожелать всем нам успешной работы, удачи в реализации поставленных целей и новых больших проектов!</p></p><h2>С.А. Зубанов</h2> <p>Генеральный директор АО «Донаэродорстрой»</p>');
                break;
        }
    });
    ...
    $('#partnersModal').on('show.bs.modal', function (event) {
        ...
        switch (text) {
            ...
            case 8: 
                ...
                break;
            case 9: 
                $('.partners-text').append(' <div class="row partners-header"> <div class="col-12 col-md-3"> <img src="img/geoka.png" srcset="img/geoka@2x.png" alt="ООО «Геокадинжиниринг»" title="ООО «Геокадинжиниринг»"> </div><div class="col-12 col-md-9"> <h1>ООО «Геокадинжиниринг»</h1> </div></div><div class="row"> <div class="col-12"> <p>ООО «Геокадинжиниринг» более 13 лет работает на рынке комплексных кадастровых работ для строительства, реконструкции и эксплуатации объектов дорожной инфраструктуры и нефтегазовой промышленности, проводимых по всей территории Российской Федерации.</p><p>Наша команда - это более 50 профессионалов в области проектирования и кадастровых работ с многолетним опытом успешной реализации крупных проектов для самых требовательных заказчиков. Наши специалисты неоднократно решали сложные задачи, связанные с проведением кадастровых работ, разработкой и утверждением проектов планировки и межевания территории, необходимых для получения разрешений на строительство, ввод объектов в эксплуатацию и регистрации прав на объекты завершенного строительства.</p><p>Наш подход к работе и успешно выполненные проекты обеспечили нам безупречную репутацию на рынке.</p><h2>Адрес: 109316, Россия, г. Москва, Волгоградский проспект, д. 43, корп. 3. БЦ «Авилон Плаза», офис 222.</h2> </div></div><div class="row"> <div class="col-12 col-md-3"> <ul class="footer"> <li><a href="https://gki-rf.ru/" target="_blank">gki-rf.ru</a></li><li><a href="mailto:info@gki-rf.ru">info@gki-rf.ru</a></li></ul> </div><div class="col-12 col-md-9"> <ul class="footer"> <li>Телефон: +7 (495) 204-87-57</li></ul> </div></div>');
                break;
